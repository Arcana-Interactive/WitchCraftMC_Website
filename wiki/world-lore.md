...
The WitchCraftMC world is a hand-seeded, vanilla-terrain survival map with custom points of interest, seasonal events, and a growing player-written history. Every build, every settlement, every ruin tells a story.
...
| Dimension | Border |
|---|---|
| Overworld | ±5,000 blocks from spawn (10k × 10k) |
...
WitchCraftMC runs **seasonal maps**. Each season has a defined lifespan (typically 4–6 months), after which:
...
*The lore of WitchCraftMC is written by its players.* There is no scripted story — the history of the server is the history its community creates. Player wars, great builds, economies that rise and fall — all of it becomes part of the tapestry.
...
<div class="wiki-callout tip">
  <span class="callout-icon"><i class="fas fa-pen"></i></span>
  <div>Want to contribute to the lore? Submit your server stories or screenshots in the <strong>#lore-submissions</strong> channel on Discord.</div>
</div>
