...
layout: wiki-page
title: In-Game Ranks
description: "The WitchCraftMC in-game ranks."
permalink: /wiki/ranks/
toc: true
...
---
Ranks are earned by ranking up through the [Archwizard](/wiki/npc/archwizard) in [Spawn](/wiki/spawn/). Each rank unlocks additional perks and quality-of-life features. You can check your current progress with `/ranks`.
...
The **Novice** rank can be obtained by ranking up at the Archwizard for $20,000.

**Perks:**
- `/pv` - 1x 6 row playervault.
