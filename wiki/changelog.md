...
<div class="wiki-callout info">
  ...
  <div>This page tracks major server updates and milestones. For real-time announcements, join the <a href="http://discord.gg/5gHJtxrMZS" target="_blank">Discord</a> and check <strong>#announcements</strong>.</div>
</div>
...
- Starter economy configured — new players begin with $0 and can earn via [voting](/wiki/commands/#server-misc) and trading.
...
<div class="wiki-callout tip">
  <span class="callout-icon"><i class="fas fa-road"></i></span>
...
Found a missing entry or have a correction? Submit a Discord ticket or post in **#wiki-suggestions** on the Discord. Screenshots and dates help a lot.

*This changelog is maintained by the WitchCraftMC staff team and community contributors.*
